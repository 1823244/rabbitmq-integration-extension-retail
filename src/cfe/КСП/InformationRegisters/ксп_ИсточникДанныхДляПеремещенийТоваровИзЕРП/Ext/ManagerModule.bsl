...
Процедура ДобавитьЗапись(ЗаказНаПеремещениеГУИД, 
	...
	Если НЕ ПредставлениеЗаказа = "" Тогда
		НовСтр.ПредставлениеЗаказа = ПредставлениеЗаказа;
	КонецЕсли;
	
	Если НЕ ПредставлениеРО = "" Тогда
		НовСтр.ПредставлениеРО = ПредставлениеРО;
	КонецЕсли;
